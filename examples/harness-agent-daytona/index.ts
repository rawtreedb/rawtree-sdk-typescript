...
const agent = new HarnessAgent({
  id: "rawtree-harness-agent-daytona-example",
  harness: claudeCode,
  sandbox: createDaytonaSandbox({
    ports: [4000],
    create: {
      language: "typescript",
      autoDeleteInterval: 0,
      labels: {
        example: "rawtree-harness-agent-daytona",
      },
    },
  }),
  instructions: [
    "You are testing RawTree telemetry for AI SDK harness agents in Daytona.",
